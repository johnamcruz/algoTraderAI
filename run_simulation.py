...
python3 algoTrader.py --backtest --backtest_data data/NQ_continuous_5min.csv --contract CON.F.US.MNQ.M26 --risk_amount 200 --max_contracts 5 --entry_conf 0.70 --model models/cisd_ote_hybrid_v5_1.onnx --strategy "cisd-ote" --simulation-days 120 --high_conf_multiplier 2.0 --max_loss 800 --profit_target 12000
