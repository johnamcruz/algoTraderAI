...
python3 algoTrader.py --backtest --backtest_data data/CME_MINI_ES1_3min.csv --contract CON.F.US.EP.Z25 --size 1 --entry_conf 0.75 --stop_pts 8.0 --target_pts 32.0 --model models/ema_pullback_v1.onnx --scaler models/ema_pullback_v1_scaler.pkl --strategy "ema_pullback" --simulation-days 5
