...
python3 algoTrader.py --backtest --backtest_data data/ES_continuous_3min.csv --contract CON.F.US.EP.Z25 --size 1 --entry_conf 0.55 --stop_pts 8.0 --target_pts 32.0 --model models/multi_tf_transformer_v6_3_3.onnx --scaler models/multi_tf_transformer_v6_3_3_scaler.pkl --strategy "mtf_directional" --simulation-days 3
